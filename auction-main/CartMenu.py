...
records = ctrl.getCartList()
for (id_product,name,buy_num) in records:
	print(f"<p>ID:{id_product} 名稱:{name} 購買數量:{buy_num}</p>")


#print("<p><a href='bidding.html'> 我要競標 </a></p>")

print("<p><a href='addCart.html'> 繼續購買 </a></p>")

print("<p><a href='buy.py'> 結賬 </a></p>")

print("<p><a href='clearCart.py'> 清空購物車 </a></p>")
